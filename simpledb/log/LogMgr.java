...
public class LogMgr {
   ...
   ArrayList<Integer> lsn_list = new ArrayList<Integer>();
   ...
   public void flush(int lsn) {
      if (lsn >= lastSavedLSN)
      {
         //Buffer buff = new Buffer(fm, null, lsn);
         //lsn_list.remove(lsn_list.indexOf(lsn));
         //buff.setLsnList(lsn_list);
         flush();
   ...
   public synchronized int append(byte[] logrec) {
      Buffer buff = new Buffer(fm, null, lastSavedLSN);
      ...
      latestLSN += 1;
      //lsn_list.add(latestLSN);
      //System.out.println("Modified: " + lsn_list);
      //buff.setLsnList(lsn_list);
      return latestLSN;
   }
